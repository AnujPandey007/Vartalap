...
export default function Profile() {
  return (
    <div className='flex flex-row'>
      <div className="mx-20 my-5 w-70 h-80 bg-white rounded-lg border border-gray-200 flex items-center gap-5">
        <div className='flex flex-col items-center pb-10'>
            ...
            <div className="flex flex-col items-center pb-10">
               <h5 className="mb-1 text-xl font-medium text-gray-900 dark:text-white">Anuj Kumar Pandey</h5>
